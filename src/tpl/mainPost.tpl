<div class="post">
    <div class="post__author">
        <div class="post__author_ava">
            <img src="%postPublisherAva%" alt="ava">
        </div>
        <div class="post__author_container">
            <div class="post__author_nick">%postPublisher%</div>
            <div class="post__author_postTime">%postDate%</div>
        </div>
