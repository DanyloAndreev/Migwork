<main class="main">
    <div class="main__profile">
        ...
        <div class="info">
            <div class="info__nick">User Nickname</div>
            <div class="info__status">User status</div>
        ...
        <div class="post">
            <div class="post__author">
                ...
                <div class="post__author_nick"></div>
                <div class="post__author_postTime"></div>
                <div class="post__author_menu"></div>
            </div>
